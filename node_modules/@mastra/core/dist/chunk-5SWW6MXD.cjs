...
var AgentsStorage = class extends chunkA3NDWEDZ_cjs.VersionedStorageDomain {
  listKey = "agents";
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      agents = agents.filter((agent) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkAX6D722J_cjs.deepEqual(agent.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-5SWW6MXD.cjs.map
//# sourceMappingURL=chunk-5SWW6MXD.cjs.map