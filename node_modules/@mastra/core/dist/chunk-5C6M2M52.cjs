...
// src/voice/voice.ts
var MastraVoice = class extends chunkFCQNDFEW_cjs.MastraBase {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunk7KR4BWEU_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunk7KR4BWEU_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
//# sourceMappingURL=chunk-5C6M2M52.cjs.map
//# sourceMappingURL=chunk-5C6M2M52.cjs.map