...
var getTraceStep = chunkIX34UNHY_cjs.createStep({
...
async function runScorerOnTarget({
  ...
  const result = await scorer.run({
    ...
    scoreSource: "trace",
    targetScope: "span",
    targetEntityType: chunk5IS5R433_cjs.getEntityTypeForSpan(span),
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkXXKOQCB4_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkIX34UNHY_cjs.createWorkflow({
