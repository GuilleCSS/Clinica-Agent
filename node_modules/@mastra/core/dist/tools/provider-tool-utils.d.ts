import type { Tool, ToolSet } from '../_types/@internal_ai-sdk-v5/dist/index.js';
/**
 * Find a provider-defined tool by its model-facing name.
 */
export declare function findProviderToolByName(tools: ToolSet | undefined, toolName: string): Tool | undefined;
/**
 ...
 */
export declare function inferProviderExecuted(providerExecuted: boolean | undefined, tool: unknown): boolean | undefined;
//# sourceMappingURL=provider-tool-utils.d.ts.map