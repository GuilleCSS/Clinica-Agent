import { MastraGateway, PROVIDER_REGISTRY, GatewayRegistry } from './chunk-IIBNQYG5.js';
import { ModelsDevGateway, parseModelRouterId } from './chunk-3TIWEIPL.js';
import { NetlifyGateway } from './chunk-PUHQJIU3.js';
...
import { AISDKV5LanguageModel, createStreamFromGenerateResult } from './chunk-YVDKR35H.js';
...
var comparisonFilterSchema2 = z.object({
  key: z.string(),
  type: z.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: z.union([z.string(), z.number(), z.boolean(), z.array(z.string())])
});
var compoundFilterSchema2 = z.object({
  type: z.enum(["and", "or"]),
  filters: z.array(
    z.union([comparisonFilterSchema2, z.lazy(() => compoundFilterSchema2)])
  )
});
var fileSearchArgsSchema3 = lazySchema(
  () => zodSchema(
    z.object({
      ...
      filters: z.union([comparisonFilterSchema2, compoundFilterSchema2]).optional()
    })
  )
);
...
var imageGenerationInputSchema2 = lazySchema(() => zodSchema(z.object({})));
...
var webSearchInputSchema2 = lazySchema(() => zodSchema(z.object({})));
...
var openaiResponsesReasoningProviderOptionsSchema2 = z.object({
  itemId: z.string().nullish(),
  reasoningEncryptedContent: z.string().nullish()
});
...
var openaiResponsesProviderOptionsSchema2 = lazyValidator(
  () => zodSchema(
    z.object({
       ...
       * @see https://cookbook.openai.com/examples/using_logprobs
       */
      logprobs: z.union([z.boolean(), z.number().min(1).max(TOP_LOGPROBS_MAX2)]).optional(),
      /**
       * The maximum number of total calls to built-in tools that can be processed in a response.
       * This maximum number applies across all built-in tool calls, not per individual tool.
       * Any further attempts to call a tool by the model will be ignored.
...
//# sourceMappingURL=chunk-RNFNMSYF.js.map
//# sourceMappingURL=chunk-RNFNMSYF.js.map