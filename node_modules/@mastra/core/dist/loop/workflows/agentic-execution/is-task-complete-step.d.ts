...
export declare function createIsTaskCompleteStep<Tools extends ToolSet = ToolSet, OUTPUT = undefined>(params: OuterLLMRun<Tools, OUTPUT>): import("../../../workflows").Step<"isTaskCompleteStep", unknown, {
    messageId: string;
    messages: {
        all: any[];
        user: any[];
...
//# sourceMappingURL=is-task-complete-step.d.ts.map