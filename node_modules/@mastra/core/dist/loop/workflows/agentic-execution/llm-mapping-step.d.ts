...
export declare function createLLMMappingStep<Tools extends ToolSet = ToolSet, OUTPUT = undefined>({ models, _internal, ...rest }: OuterLLMRun<Tools, OUTPUT>, llmExecutionStep: any): import("../../../workflows").Step<"llmExecutionMappingStep", unknown, {
    toolCallId: string;
    toolName: string;
