...
export declare function createPrepareStreamWorkflow<OUTPUT = undefined>({ capabilities, options, threadFromArgs, resourceId, runId, requestContext, agentSpan, methodType, instructions, memoryConfig, memory, returnScorerData, saveQueueManager, requireToolApproval, toolCallConcurrency, resumeContext, agentId, agentName, toolCallId, workspace, backgroundTaskManager, agentBackgroundConfig, skipBgTaskWait, }: CreatePrepareStreamWorkflowOptions<OUTPUT>): import("../../../workflows").Workflow<import("../../../workflows").DefaultEngineType, (import("../../../workflows").Step<"prepare-tools-step", unknown, Record<string, never>, {
    convertedTools: Record<string, any>;
}, unknown, unknown, import("../../../workflows").DefaultEngineType, unknown> | import("../../../workflows").Step<"prepare-memory-step", unknown, Record<string, never>, {
...
}, unknown, unknown, import("../../../workflows").DefaultEngineType, unknown> | import("../../../workflows").Step<"stream-text-step", unknown, any, MastraModelOutput<undefined>, unknown, unknown, import("../../../workflows").DefaultEngineType, unknown>)[], "execution-workflow", unknown, Record<string, never>, MastraModelOutput<OUTPUT>, MastraModelOutput<OUTPUT>, unknown>;
export {};
