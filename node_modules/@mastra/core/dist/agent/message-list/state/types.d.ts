...
import type * as AIV5 from '../../../_types/@internal_ai-sdk-v5/dist/index.js';
...
export type MastraMessagePart = PartWithProviderMetadata<Exclude<UIMessageV4['parts'][number], {
    type: 'tool-invocation' | 'source' | 'step-start';
}>> | MastraStepStartPart | MastraToolInvocationPart | MastraSourceUrlPart | MastraSourceDocumentPart | PartWithProviderMetadata<AIV5Type.DataUIPart<AIV5.UIDataTypes>>;
