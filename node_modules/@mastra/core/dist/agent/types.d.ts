import type { GenerateTextOnStepFinishCallback } from '../_types/@internal_ai-sdk-v4/dist/index.js';
import type { CallSettings } from '../_types/@internal_ai-sdk-v5/dist/index.js';
...
import type { AgentChannels, ChannelConfig } from '../channels/agent-channels.js';
...
import type { MastraOnFinishCallbackArgs, ModelManagerModelConfig } from '../stream/types.js';
...
export type { Message as AiMessageType } from '../_types/@internal_ai-sdk-v4/dist/index.js';
...
export interface AgentConfig<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, TRequestContext extends Record<string, any> | unknown = unknown> {
    /**
