 ...
 */
export declare function createDurableAgenticWorkflow(options?: DurableAgenticWorkflowOptions): import("../../../workflows").Workflow<import("../../../workflows").DefaultEngineType, import("../../../workflows").Step<string, unknown, unknown, unknown, unknown, unknown, any, unknown>[], "durable-agentic-loop", unknown, {
...
//# sourceMappingURL=create-durable-agentic-workflow.d.ts.map