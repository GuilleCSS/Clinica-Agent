...
export declare const modelConfigSchema: z.ZodObject<{
    ...
    modelId: z.ZodString;
    specificationVersion: z.ZodOptional<z.ZodString>;
    settings: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
}, z.core.$strip>;
/**
 * Schema for model list entry (fallback support)
 */
export declare const modelListEntrySchema: z.ZodObject<{
    id: z.ZodString;
    config: z.ZodObject<{
        provider: z.ZodString;
        modelId: z.ZodString;
        specificationVersion: z.ZodOptional<z.ZodString>;
        originalConfig: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodRecord<z.ZodString, z.ZodAny>]>>;
    }, z.core.$strip>;
 ...
 */
export declare const accumulatedUsageSchema: z.ZodObject<{
 ...
 */
export declare const durableAgenticOutputSchema: z.ZodObject<{
    messageListState: z.ZodAny;
 ...
 */
export declare const baseDurableAgenticInputSchema: z.ZodObject<{
    runId: z.ZodString;
    agentId: z.ZodString;
    agentName: z.ZodOptional<z.ZodString>;
    messageListState: z.ZodAny;
    toolsMetadata: z.ZodArray<z.ZodAny>;
 ...
 * Implementations can extend this with additional fields.
 */
export declare const baseIterationStateSchema: z.ZodObject<{
    runId: z.ZodString;
    agentId: z.ZodString;
    agentName: z.ZodOptional<z.ZodString>;
    messageListState: z.ZodAny;
    ...
    accumulatedSteps: z.ZodArray<z.ZodAny>;
    accumulatedUsage: z.ZodObject<{
        inputTokens: z.ZodNumber;
        outputTokens: z.ZodNumber;
        totalTokens: z.ZodNumber;
    }, z.core.$strip>;
    lastStepResult: z.ZodOptional<z.ZodAny>;
