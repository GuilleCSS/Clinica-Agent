...
var chunkQPZ35KK2_cjs = require('./chunk-QPZ35KK2.cjs');
var chunkZCBG4ZQT_cjs = require('./chunk-ZCBG4ZQT.cjs');
var chunkB7CR6B45_cjs = require('./chunk-B7CR6B45.cjs');
var chunkB5SLBAGA_cjs = require('./chunk-B5SLBAGA.cjs');
var chunkCDN65CUN_cjs = require('./chunk-CDN65CUN.cjs');
var chunk5IS5R433_cjs = require('./chunk-5IS5R433.cjs');
var chunkEGOKFX44_cjs = require('./chunk-EGOKFX44.cjs');
...
var StepExecutor = class extends chunkFCQNDFEW_cjs.MastraBase {
  mastra;
  constructor({ mastra }) {
    super({ name: "StepExecutor", component: chunk7GW2TQXP_cjs.RegisteredLogger.WORKFLOW });
    this.mastra = mastra;
  }
  ...
  async execute(params) {
    ...
    const { inputData, validationError } = await chunkQPZ35KK2_cjs.validateStepInput({
    ...
    try {
      ...
      const stepOutput = await chunk5IS5R433_cjs.executeWithContext({
        span: params.tracingContext?.currentSpan,
        fn: () => step.execute(
          chunkQPZ35KK2_cjs.createDeprecationProxy(
            {
              ...
              getStepResult: chunkQPZ35KK2_cjs.getStepResult.bind(this, stepResults),
              suspend: async (suspendPayload, suspendOptions) => {
                const { suspendData, validationError: validationError2 } = await chunkQPZ35KK2_cjs.validateStepSuspendData({
              ...
              [chunkZCBG4ZQT_cjs.STREAM_FORMAT_SYMBOL]: params.format,
              engine: {},
              abortSignal: abortController?.signal,
              ...chunkCDN65CUN_cjs.createObservabilityContext(params.tracingContext)
            },
            {
              paramName: "runCount",
              deprecationMessage: chunkQPZ35KK2_cjs.runCountDeprecationMessage,
              logger: this.logger
            }
          )
        )
      ...
      return {
        ...
        tripwire: error instanceof chunkQPZ35KK2_cjs.TripWire ? {
      ...
      chunkQPZ35KK2_cjs.createDeprecationProxy(
        {
          ...
          abortSignal: abortController?.signal,
          // TODO
          ...chunkCDN65CUN_cjs.createObservabilityContext(),
          iterationCount
        },
        {
          paramName: "runCount",
...
function createTripWireFromChunk(chunk) {
  const { payload } = chunk;
  return new chunkQPZ35KK2_cjs.TripWire(
...
async function processWorkflowLoop({
  ...
  const reqContext = new chunkKF4FCWWL_cjs.RequestContext(Object.entries(requestContext ?? {}));
  ...
  if (resumeData !== void 0 && forEachIndex === void 0 && currentResult?.output?.length > 0) {
    ...
    if (suspendedIndices.length > 0) {
      ...
      for (const suspIdx of indicesToResume) {
        updatedOutput[suspIdx] = chunkB7CR6B45_cjs.createPendingMarker();
      }
  ...
  async processWorkflowStepRun({
    ...
    if (step.step instanceof EventedWorkflow || step.step.component === "WORKFLOW") {
      if (resumeSteps?.length === 1 && resumeSteps[0] === step.step.id) {
        ...
        const timeTravelParams = chunkQPZ35KK2_cjs.createTimeTravelExecutionParams({
    ...
    const rc = new chunkKF4FCWWL_cjs.RequestContext();
    for (const [key, value] of Object.entries(requestContext)) {
      rc.set(key, value);
    }
    const { resumeData: timeTravelResumeData, validationError: timeTravelResumeValidationError } = await chunkQPZ35KK2_cjs.validateStepResumeData({
...
function cloneWorkflow(workflow, opts) {
  const wf = new chunkQPZ35KK2_cjs.Workflow({
    id: opts.id,
...
function isAgent(input) {
  return input instanceof chunkQPZ35KK2_cjs.Agent;
}
function isToolStep(input) {
  return input instanceof chunkM4KUR53T_cjs.Tool;
}
function isStepParams(input) {
  return input !== null && typeof input === "object" && "id" in input && "execute" in input && !(input instanceof chunkQPZ35KK2_cjs.Agent) && !(input instanceof chunkM4KUR53T_cjs.Tool);
}
function isProcessor(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && !(obj instanceof chunkQPZ35KK2_cjs.Agent) && !(obj instanceof chunkM4KUR53T_cjs.Tool) && (typeof obj.processInput === "function" || typeof obj.processInputStep === "function" || typeof obj.processOutputStream === "function" || typeof obj.processOutputResult === "function" || typeof obj.processOutputStep === "function");
}
function areProcessorMessageArraysEqual(before, after) {
  ...
  return before.length === after.length && before.every((message, index) => chunkB5SLBAGA_cjs.messagesAreEqual(message, after[index]));
}
...
function createStepFromParams(params) {
  return {
    ...
    inputSchema: chunkXB4FLS7A_cjs.toStandardSchema(params.inputSchema),
    stateSchema: params.stateSchema ? chunkXB4FLS7A_cjs.toStandardSchema(params.stateSchema) : void 0,
    outputSchema: chunkXB4FLS7A_cjs.toStandardSchema(params.outputSchema),
    resumeSchema: params.resumeSchema ? chunkXB4FLS7A_cjs.toStandardSchema(params.resumeSchema) : void 0,
    suspendSchema: params.suspendSchema ? chunkXB4FLS7A_cjs.toStandardSchema(params.suspendSchema) : void 0,
    requestContextSchema: params.requestContextSchema ? chunkXB4FLS7A_cjs.toStandardSchema(params.requestContextSchema) : void 0,
...
async function processAgentStream(params) {
  ...
  for await (const chunk of fullStream) {
    ...
    if (streamFormat !== "legacy") {
      await chunkQPZ35KK2_cjs.forwardAgentStreamChunk({ writer, chunk });
    }
  }
  try {
    await pubsub.publish(`workflow.events.v2.${runId}`, {
...
function createStepFromAgent(params, agentOrToolOptions) {
  ...
  const outputSchema = options?.structuredOutput?.schema ?? v4.z.object({ text: v4.z.string() });
  ...
  return {
    ...
    outputSchema: chunkXB4FLS7A_cjs.toStandardSchema(outputSchema),
    retries,
    scorers,
    metadata,
    execute: async ({
      ...
      const observabilityContext = chunkCDN65CUN_cjs.resolveObservabilityContext(obsFields);
      const logger = mastra?.getLogger();
      const toolData = {
        name: params.name,
        args: inputData
      ...
      const isV2Model = chunkQPZ35KK2_cjs.isSupportedLanguageModel(modelInfo);
...
function createStepFromProcessor(processor) {
  const getProcessorEntityType = (phase) => {
    switch (phase) {
      case "input":
        return chunkEGOKFX44_cjs.EntityType.INPUT_PROCESSOR;
      case "inputStep":
        return chunkEGOKFX44_cjs.EntityType.INPUT_STEP_PROCESSOR;
      case "outputStream":
      case "outputResult":
        return chunkEGOKFX44_cjs.EntityType.OUTPUT_PROCESSOR;
      case "outputStep":
        return chunkEGOKFX44_cjs.EntityType.OUTPUT_STEP_PROCESSOR;
      default:
        return chunkEGOKFX44_cjs.EntityType.OUTPUT_PROCESSOR;
    }
  };
  ...
  return {
    ...
    inputSchema: chunkXB4FLS7A_cjs.toStandardSchema(chunkQPZ35KK2_cjs.ProcessorStepSchema),
    outputSchema: chunkXB4FLS7A_cjs.toStandardSchema(chunkQPZ35KK2_cjs.ProcessorStepOutputSchema),
    execute: async ({ inputData, requestContext, ...obsFields }) => {
      ...
      const abort = (reason, options) => {
        throw new chunkQPZ35KK2_cjs.TripWire(reason || `Tripwire triggered by ${processor.id}`, options, processor.id);
      };
      ...
      const buildProcessorSpanInput = () => {
        switch (phase) {
          ...
          case "inputStep": {
            const summarizedModel = chunkQPZ35KK2_cjs.summarizeProcessorModelForSpan(model);
            const summarizedTools = chunkQPZ35KK2_cjs.summarizeProcessorToolsForSpan(tools);
            const summarizedToolChoice = chunkQPZ35KK2_cjs.summarizeToolChoiceForSpan(toolChoice, tools);
            const summarizedActiveTools = chunkQPZ35KK2_cjs.summarizeActiveToolsForSpan(activeTools, tools);
            return {
              messages: messages ?? [],
              ...systemMessages ? { systemMessages } : {},
              ...stepNumber !== void 0 ? { stepNumber } : {},
          ...
          case "outputResult": {
            const summarizedResult = chunkQPZ35KK2_cjs.summarizeProcessorResultForSpan(outputResult ?? defaultOutputResult);
            return {
              messages: messages ?? [],
      ...
      const buildProcessorSpanOutput = (result) => {
        ...
        switch (phase) {
          case "input":
            return {
              ...Array.isArray(payload.messages) && !areProcessorMessageArraysEqual(messages, payload.messages) ? { messages: payload.messages } : {},
              ...Array.isArray(payload.systemMessages) && !areProcessorMessageArraysEqual(systemMessages, payload.systemMessages) ? { systemMessages: payload.systemMessages } : {}
            };
          case "inputStep": {
            const output = {};
            if (Array.isArray(payload.messages) && !areProcessorMessageArraysEqual(messages, payload.messages)) {
              output.messages = payload.messages;
            }
            if (Array.isArray(payload.systemMessages) && !areProcessorMessageArraysEqual(systemMessages, payload.systemMessages)) {
              output.systemMessages = payload.systemMessages;
            }
            if (payload.messageId !== void 0 && payload.messageId !== initialMessageId) {
              output.messageId = payload.messageId;
            }
            if (payload.model !== void 0 && payload.model !== model) {
              const summarizedModel = chunkQPZ35KK2_cjs.summarizeProcessorModelForSpan(payload.model);
              if (summarizedModel) {
                output.model = summarizedModel;
              }
            }
            if (payload.tools !== void 0 && payload.tools !== tools) {
              const summarizedTools = chunkQPZ35KK2_cjs.summarizeProcessorToolsForSpan(payload.tools);
              if (summarizedTools) {
                output.tools = summarizedTools;
              }
            }
            if (payload.toolChoice !== void 0 && payload.toolChoice !== toolChoice) {
              const summarizedToolChoice = chunkQPZ35KK2_cjs.summarizeToolChoiceForSpan(payload.toolChoice, payload.tools ?? tools);
            ...
            if (payload.activeTools !== void 0 && payload.activeTools !== activeTools) {
              const summarizedActiveTools = chunkQPZ35KK2_cjs.summarizeActiveToolsForSpan(payload.activeTools, payload.tools ?? tools);
              if (summarizedActiveTools) {
                output.activeTools = summarizedActiveTools;
              }
            }
            if (payload.retryCount !== void 0 && payload.retryCount !== retryCount) {
      ...
      const processorObservabilityContext = chunkCDN65CUN_cjs.createObservabilityContext(
      ...
      if (processorStates) {
        ...
        if (!ps) {
          ps = new chunkQPZ35KK2_cjs.ProcessorState();
      ...
      const passThrough = {
        ...
        messageList: messageList ?? (Array.isArray(messages) ? new chunkB5SLBAGA_cjs.MessageList().add(messages, "input").addSystem(systemMessages ?? []) : void 0),
        stepNumber,
        systemMessages,
        streamParts,
        state: processorState,
      ...
      const executePhaseWithSpan = async (fn) => {
        try {
          const result = await chunk5IS5R433_cjs.executeWithContext({ span: processorSpan, fn });
          processorSpan?.end({ output: buildProcessorSpanOutput(result) });
          return result;
        } catch (error) {
          if (error instanceof chunkQPZ35KK2_cjs.TripWire) {
        ...
        switch (phase) {
          case "input": {
            if (processor.processInput) {
              ...
              if (result instanceof chunkB5SLBAGA_cjs.MessageList) {
                ...
                chunkQPZ35KK2_cjs.ProcessorRunner.applyMessagesToMessageList(
                  result,
          ...
          case "inputStep": {
            if (processor.processInputStep) {
              ...
              const validatedResult = await chunkQPZ35KK2_cjs.ProcessorRunner.validateAndFormatProcessInputStepResult(result, {
                messageList: passThrough.messageList,
                processor,
                stepNumber: stepNumber ?? 0
              });
            ...
            if (processor.processOutputStream && part) {
              ...
              if (!processorSpan2 && parentSpan) {
                processorSpan2 = parentSpan.createChildSpan({
                  ...
                  entityType: chunkEGOKFX44_cjs.EntityType.OUTPUT_PROCESSOR,
                  entityId: processor.id,
                  entityName: processor.name ?? processor.id,
                  attributes: {
                    processorExecutor: "workflow",
              ...
              const processorObservabilityContext2 = chunkCDN65CUN_cjs.createObservabilityContext(
...
function createWorkflow(params) {
  if (params.schedule) {
    ...
    for (const entry of schedules) {
      chunkQPZ35KK2_cjs.validateCron(entry.cron, entry.timezone);
    }
  }
...
chunkQPZ35KK2_cjs.__registerEventedCreateWorkflow(createWorkflow);
var EventedWorkflow = class extends chunkQPZ35KK2_cjs.Workflow {
  #schedules;
  constructor(params) {
    super(params);
...
var EventedRun = class extends chunkQPZ35KK2_cjs.Run {
  constructor(params) {
    super(params);
  ...
  stream({
    ...
    this.streamOutput = new chunkQPZ35KK2_cjs.WorkflowRunOutput({
      runId: this.runId,
      workflowId: this.workflowId,
      stream
    });
...
var EventedExecutionEngine = class extends chunkQPZ35KK2_cjs.ExecutionEngine {
  eventProcessor;
  constructor({
    mastra,
    eventProcessor,
  ...
  async execute(params) {
    ...
    const finishCb = async (event, ack) => {
      ...
      if (["workflow.end", "workflow.fail", "workflow.suspend"].includes(event.type)) {
        ...
        if (event.type === "workflow.fail" && event.data.stepResults) {
          event.data.stepResults = chunkQPZ35KK2_cjs.hydrateSerializedStepErrors(event.data.stepResults);
        }
    ...
    for (const [stepId, stepResult] of Object.entries(stepResultsWithoutTopLevelState)) {
      cleanStepResults[stepId] = chunkQPZ35KK2_cjs.cleanStepResult(stepResult);
    }
    let callbackArg;
...
//# sourceMappingURL=chunk-IX34UNHY.cjs.map
//# sourceMappingURL=chunk-IX34UNHY.cjs.map