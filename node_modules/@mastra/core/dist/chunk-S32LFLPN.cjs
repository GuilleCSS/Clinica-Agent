...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunk6CFOTCM4_cjs.withoutTrailingSlash(
  ...
  const createLanguageModel = (modelId) => {
    return new chunk6CFOTCM4_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunk6CFOTCM4_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunk6CFOTCM4_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunk6CFOTCM4_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunk6CFOTCM4_cjs.createJsonErrorResponseHandler({
...
var DeepInfraChatLanguageModel = class extends chunk6CFOTCM4_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunk6CFOTCM4_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunk6CFOTCM4_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunk6CFOTCM4_cjs.lazySchema(
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunk6CFOTCM4_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunk6CFOTCM4_cjs.generateId(),
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunk6CFOTCM4_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunk6CFOTCM4_cjs.generateId(),
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunk6CFOTCM4_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunk6CFOTCM4_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
            ...
            switch (part.type) {
              ...
              case "file": {
                if (!part.mediaType.startsWith("image/")) {
                  throw new chunk6CFOTCM4_cjs.UnsupportedFunctionalityError2({
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunk6CFOTCM4_cjs.convertToBase642(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler2({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b, _c;
    const warnings = [];
    const groqOptions = await chunk6CFOTCM4_cjs.parseProviderOptions2({
      provider: "groq",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      value: response,
      rawValue: rawResponse
    } = await chunk6CFOTCM4_cjs.postJsonToApi2({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunk6CFOTCM4_cjs.combineHeaders2(this.config.headers(), options.headers),
      body: args,
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createJsonResponseHandler2(
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunk6CFOTCM4_cjs.generateId2(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi2({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createEventSourceResponseHandler2(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type !== "function") {
                    throw new chunk6CFOTCM4_cjs.InvalidResponseDataError2({
                      data: toolCallDelta,
                  ...
                  if (((_d = toolCall2.function) == null ? void 0 : _d.name) != null && ((_e = toolCall2.function) == null ? void 0 : _e.arguments) != null) {
                    ...
                    if (chunk6CFOTCM4_cjs.isParsableJson2(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_f = toolCall2.id) != null ? _f : chunk6CFOTCM4_cjs.generateId2(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_k = toolCall.function) == null ? void 0 : _k.name) != null && ((_l = toolCall.function) == null ? void 0 : _l.arguments) != null && chunk6CFOTCM4_cjs.isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_m = toolCall.id) != null ? _m : chunk6CFOTCM4_cjs.generateId2(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var groqTranscriptionModelOptions = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunk6CFOTCM4_cjs.convertBase64ToUint8Array2(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunk6CFOTCM4_cjs.mediaTypeToExtension2(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunk6CFOTCM4_cjs.postFormDataToApi2({
      url: this.config.url({
...
var browserSearch = chunk6CFOTCM4_cjs.createProviderToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunk6CFOTCM4_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunk6CFOTCM4_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunk6CFOTCM4_cjs.loadApiKey2({
        apiKey: options.apiKey,
  ...
  provider.embeddingModel = (modelId) => {
    throw new chunk6CFOTCM4_cjs.NoSuchModelError2({ modelId, modelType: "embeddingModel" });
  };
  provider.textEmbeddingModel = provider.embeddingModel;
  provider.imageModel = (modelId) => {
    throw new chunk6CFOTCM4_cjs.NoSuchModelError2({ modelId, modelType: "imageModel" });
  };
...
function formatFileUrl({
  ...
  return data instanceof URL ? data.toString() : `data:${mediaType};base64,${chunk6CFOTCM4_cjs.convertToBase642(data)}`;
}
...
var mistralFailedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler2({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunk6CFOTCM4_cjs.generateId2;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunk6CFOTCM4_cjs.parseProviderOptions2({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunk6CFOTCM4_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi2({
      ...
      body,
      failedResponseHandler: mistralFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createEventSourceResponseHandler2(
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunk6CFOTCM4_cjs.TooManyEmbeddingValuesForCallError2({
    ...
    const {
      ...
      headers: chunk6CFOTCM4_cjs.combineHeaders2(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunk6CFOTCM4_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunk6CFOTCM4_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunk6CFOTCM4_cjs.loadApiKey2({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunk6CFOTCM4_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunk6CFOTCM4_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunk6CFOTCM4_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunk6CFOTCM4_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const getHeaders = () => {
    var _a22;
    return chunk6CFOTCM4_cjs.withUserAgentSuffix(
      {
        Authorization: `Bearer ${chunk6CFOTCM4_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    return new chunk6CFOTCM4_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
var xaiFailedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler2({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunk6CFOTCM4_cjs.APICallError2({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi2({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunk6CFOTCM4_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunk6CFOTCM4_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunk6CFOTCM4_cjs.createEventSourceResponseHandler2(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
...
var XaiImageModel = class {
  ...
  async doGenerate({
    ...
    const xaiOptions = await chunk6CFOTCM4_cjs.parseProviderOptions2({
      provider: "xai",
      providerOptions,
      schema: xaiImageModelOptions
    });
    const hasFiles = files != null && files.length > 0;
    const imageUrls = hasFiles ? files.map((file) => chunk6CFOTCM4_cjs.convertImageModelFileToDataUri(file)) : [];
    ...
    const { value: response, responseHeaders } = await chunk6CFOTCM4_cjs.postJsonToApi2({
  ...
  async downloadImage(url, abortSignal) {
    const { value } = await chunk6CFOTCM4_cjs.getFromApi({
      url,
      abortSignal,
      failedResponseHandler: chunk6CFOTCM4_cjs.createStatusCodeErrorResponseHandler(),
      successfulResponseHandler: chunk6CFOTCM4_cjs.createBinaryResponseHandler2(),
      fetch: this.config.fetch
    });
    return value;
  }
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunk6CFOTCM4_cjs.convertToBase642(block.data)}`;
...
var fileSearchArgsSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchOutputSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.file_search",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema2(() => chunk6CFOTCM4_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: fileSearchOutputSchema
});
var fileSearch = (args) => fileSearchToolFactory(args);
var mcpServerArgsSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var mcpServerOutputSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
      name: v4.z.string(),
      arguments: v4.z.string(),
...
var mcpServerToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.mcp",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema2(() => chunk6CFOTCM4_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: mcpServerOutputSchema
});
var mcpServer = (args) => mcpServerToolFactory(args);
var webSearchArgsSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var webSearchOutputSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.web_search",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema2(() => chunk6CFOTCM4_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
...
var xSearchOutputSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.x_search",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema2(() => chunk6CFOTCM4_cjs.zodSchema2(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunk6CFOTCM4_cjs.validateTypes2({
            value: tool.args,
...
var codeExecutionToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunk6CFOTCM4_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var xaiVideoModelOptionsSchema = chunk6CFOTCM4_cjs.lazySchema2(
  () => chunk6CFOTCM4_cjs.zodSchema2(runtimeSchema)
);
var RESOLUTION_MAP = {
  "1280x720": "720p",
  "854x480": "480p",
  ...
  async doGenerate(options) {
    ...
    if (options.image != null) {
      if (options.image.type === "url") {
        ...
        const base64Data = typeof options.image.data === "string" ? options.image.data : chunk6CFOTCM4_cjs.convertUint8ArrayToBase642(options.image.data);
        body.image = {
    ...
    const { value: createResponse } = await chunk6CFOTCM4_cjs.postJsonToApi2({
      url: endpoint,
      headers: chunk6CFOTCM4_cjs.combineHeaders2(this.config.headers(), options.headers),
      body,
      failedResponseHandler: xaiFailedResponseHandler,
    ...
    if (!requestId) {
      throw new chunk6CFOTCM4_cjs.AISDKError({
    ...
    let responseHeaders;
    while (true) {
      await chunk6CFOTCM4_cjs.delay(pollIntervalMs, { abortSignal: options.abortSignal });
      ...
      const { value: statusResponse, responseHeaders: pollHeaders } = await chunk6CFOTCM4_cjs.getFromApi({
...
function createXai(options = {}) {
  var _a15;
  const baseURL = chunk6CFOTCM4_cjs.withoutTrailingSlash2(
  ...
  const createChatLanguageModel = (modelId) => {
    return new XaiChatLanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: chunk6CFOTCM4_cjs.generateId2,
      fetch: options.fetch
    });
  };
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (((_l = toolCall.function) == null ? void 0 : _l.name) != null && ((_m = toolCall.function) == null ? void 0 : _m.arguments) != null && isParsableJson3(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_n = toolCall.id) != null ? _n : generateId3(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.sent = true;
...
var ModelsDevGateway = class extends chunk6CFOTCM4_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunk6CFOTCM4_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunk6CFOTCM4_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
  ...
  async resolveLanguageModel({
    ...
    const mastraHeaders = { "User-Agent": chunk6CFOTCM4_cjs.MASTRA_USER_AGENT, ...headers };
    switch (providerId) {
      case "openai":
        return chunk6CFOTCM4_cjs.createOpenAI({ apiKey, headers: mastraHeaders }).responses(modelId);
      case "gemini":
      case "google":
        return chunk6CFOTCM4_cjs.createGoogleGenerativeAI({ apiKey, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunk6CFOTCM4_cjs.createAnthropic({ apiKey, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      case "vercel":
        return chunkMWU53QPO_cjs.createGatewayProvider({ apiKey, headers: mastraHeaders })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunk6CFOTCM4_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      }
      default: {
        const config = this.providerConfigs[providerId];
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunk6CFOTCM4_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        if (npm === "@ai-sdk/google") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunk6CFOTCM4_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        ...
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunk6CFOTCM4_cjs.createOpenAICompatible({
          name: providerId,
          apiKey,
          baseURL,
...
//# sourceMappingURL=chunk-S32LFLPN.cjs.map
//# sourceMappingURL=chunk-S32LFLPN.cjs.map