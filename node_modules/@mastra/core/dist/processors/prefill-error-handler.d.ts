 ...
 */
export declare class PrefillErrorHandler implements Processor<'prefill-error-handler'> {
    readonly id: "prefill-error-handler";
    readonly name = "Prefill Error Handler";
    processAPIError({ error, messageList, retryCount, writer, rotateResponseMessageId, }: ProcessAPIErrorArgs): Promise<ProcessAPIErrorResult | void>;
}
//# sourceMappingURL=prefill-error-handler.d.ts.map