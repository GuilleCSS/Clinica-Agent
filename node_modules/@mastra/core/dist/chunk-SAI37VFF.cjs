...
var MastraGateway = class extends chunk6CFOTCM4_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunk6CFOTCM4_cjs.createAnthropic({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk6CFOTCM4_cjs.MASTRA_USER_AGENT,
          [chunk6CFOTCM4_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunkS32LFLPN_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunk6CFOTCM4_cjs.MASTRA_USER_AGENT,
...
var provider_registry_default = {
  providers: {
    ...
    "xiaomi-token-plan-cn": {
      ...
      models: ["mimo-v2-omni", "mimo-v2-pro", "mimo-v2-tts", "mimo-v2.5", "mimo-v2.5-pro"],
  ...
  models: {
    ...
    "xiaomi-token-plan-cn": ["mimo-v2-omni", "mimo-v2-pro", "mimo-v2-tts", "mimo-v2.5", "mimo-v2.5-pro"],
    wandb: [
      "MiniMaxAI/MiniMax-M2.5",
      "OpenPipe/Qwen3-14B-Instruct",
      "Qwen/Qwen3-235B-A22B-Instruct-2507",
    ...
    "xiaomi-token-plan-sgp": ["mimo-v2-omni", "mimo-v2-pro", "mimo-v2-tts", "mimo-v2.5", "mimo-v2.5-pro"],
    zai: [
      "glm-4.5",
      "glm-4.5-air",
      "glm-4.5-flash",
    ...
    "wafer.ai": ["DeepSeek-V4-Pro", "GLM-5.1", "Qwen3.5-397B-A17B"],
    "cloudferro-sherlock": [
      "MiniMaxAI/MiniMax-M2.5",
      "meta-llama/Llama-3.3-70B-Instruct",
      "openai/gpt-oss-120b",
    ...
    "xiaomi-token-plan-ams": ["mimo-v2-omni", "mimo-v2-pro", "mimo-v2-tts", "mimo-v2.5", "mimo-v2.5-pro"],
    zhipuai: [
      "glm-4.5",
      "glm-4.5-air",
      "glm-4.5-flash",
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-SAI37VFF.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunkS32LFLPN_cjs.ModelsDevGateway({}),
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-4IKKAR6E.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-W7FYJBAT.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-BC32LUTX.cjs');
...
//# sourceMappingURL=chunk-SAI37VFF.cjs.map
//# sourceMappingURL=chunk-SAI37VFF.cjs.map