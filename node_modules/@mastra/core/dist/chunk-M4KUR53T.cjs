        ...
        if (!context) {
          ...
          if (isAgentExecution && !baseContext.agent) {
            ...
            organizedContext = {
              ...
              requestContext: rest.requestContext || new chunkKF4FCWWL_cjs.RequestContext()
            };
            ...
            organizedContext = {
              ...
              requestContext: baseContext.requestContext || new chunkKF4FCWWL_cjs.RequestContext()
            };
          }
        }
...
//# sourceMappingURL=chunk-M4KUR53T.cjs.map
//# sourceMappingURL=chunk-M4KUR53T.cjs.map