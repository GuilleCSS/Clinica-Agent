...
// src/server/auth.ts
var MastraAuthProvider = class extends chunkFCQNDFEW_cjs.MastraBase {
  protected;
  public;
  constructor(options) {
...
// src/server/base.ts
var MastraServerBase = class extends chunkFCQNDFEW_cjs.MastraBase {
  #app;
  constructor({ app, name }) {
    super({ component: chunk7GW2TQXP_cjs.RegisteredLogger.SERVER, name: name ?? "Server" });
    this.#app = app;
  }
  /**
