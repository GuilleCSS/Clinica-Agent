import { ModelsDevGateway, createOpenRouter } from './chunk-3TIWEIPL.js';
import { NetlifyGateway } from './chunk-PUHQJIU3.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-3K2UXV2P.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-72IOTTPQ.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-OBBPI7AA.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-QKQ7ZTQH.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-QMLHG25G.js');
...
export { GatewayRegistry, MastraGateway, PROVIDER_MODELS, PROVIDER_REGISTRY, getProviderConfig, getRegisteredProviders, isOfflineMode, isProviderRegistered, isValidModelId, parseModelString };
//# sourceMappingURL=chunk-IIBNQYG5.js.map
//# sourceMappingURL=chunk-IIBNQYG5.js.map