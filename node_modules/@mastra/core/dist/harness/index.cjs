...
var chunkTLJ4XI7U_cjs = require('../chunk-TLJ4XI7U.cjs');
...
var submitPlanTool = chunkM4KUR53T_cjs.createTool({
  id: "submit_plan",
...
var taskItemSchema = v4.z.object({
...
var taskWriteTool = chunkM4KUR53T_cjs.createTool({
  id: "task_write",
...
- completed: Finished successfully`,
  inputSchema: v4.z.object({
    tasks: v4.z.array(taskItemSchema).describe("The complete updated task list")
  }),
...
var taskCheckTool = chunkM4KUR53T_cjs.createTool({
  id: "task_check",
...
function createSubagentTool(opts) {
  ...
  return chunkM4KUR53T_cjs.createTool({
    id: "subagent",
...
${FORKED_SUBAGENT_NESTING_NOTICE}`;
        ...
        if (context?.requestContext) {
          subagentRequestContext = new chunkKF4FCWWL_cjs.RequestContext(context.requestContext.entries());
          if (harnessCtx) {
        ...
        subagentToRun = new chunkQPZ35KK2_cjs.Agent({
...
var Harness = class {
  ...
  async init() {
    if (this.config.storage) {
      this.#internalMastra = new chunkTLJ4XI7U_cjs.Mastra({
        logger: false,
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-UM6NWWSW.cjs');
...
\`\`\`` };
      ...
      } else if (error instanceof Error && /does not support assistant message prefill|must end with a user message/i.test(error.message)) {
        this.emit({
          type: "error",
  ...
  convertToHarnessMessage(msg) {
    const content = [];
    const systemReminder = typeof msg.content.metadata?.systemReminder === "object" && msg.content.metadata.systemReminder !== null ? msg.content.metadata.systemReminder : void 0;
    if (systemReminder && "type" in systemReminder && typeof systemReminder.type === "string") {
      content.push({
        ...
        path: "path" in systemReminder && typeof systemReminder.path === "string" ? systemReminder.path : void 0,
        precedesMessageId: "precedesMessageId" in systemReminder && typeof systemReminder.precedesMessageId === "string" ? systemReminder.precedesMessageId : void 0,
        gapText: "gapText" in systemReminder && typeof systemReminder.gapText === "string" ? systemReminder.gapText : void 0,
        gapMs: "gapMs" in systemReminder && typeof systemReminder.gapMs === "number" ? systemReminder.gapMs : void 0,
        timestamp: "timestamp" in systemReminder && typeof systemReminder.timestamp === "string" ? systemReminder.timestamp : void 0
      });
      return {
        id: msg.id,
        role: msg.role,
        ...
        case "data-system-reminder": {
          ...
          if (typeof message === "string") {
            content.push({
              type: "system_reminder",
              message,
              reminderType: typeof data.reminderType === "string" ? data.reminderType : void 0,
              path: typeof data.path === "string" ? data.path : void 0,
              precedesMessageId: typeof data.precedesMessageId === "string" ? data.precedesMessageId : void 0,
              gapText: typeof data.gapText === "string" ? data.gapText : void 0,
              gapMs: typeof data.gapMs === "number" ? data.gapMs : void 0,
  ...
  async processStream(response, requestContext) {
        ...
        case "data-system-reminder": {
          ...
          if (typeof message === "string") {
            currentMessage.content.push({
              type: "system_reminder",
              message,
              reminderType: typeof payload?.reminderType === "string" ? payload.reminderType : void 0,
              path: typeof payload?.path === "string" ? payload.path : void 0,
              precedesMessageId: typeof payload?.precedesMessageId === "string" ? payload.precedesMessageId : void 0,
              gapText: typeof payload?.gapText === "string" ? payload.gapText : void 0,
              gapMs: typeof payload?.gapMs === "number" ? payload.gapMs : void 0,
              timestamp: typeof payload?.timestamp === "string" ? payload.timestamp : void 0
            });
            this.emit({ type: "message_update", message: currentMessage });
          }
          break;
    ...
    return { message: currentMessage, suspended: isSuspended || void 0 };
  }
  // ===========================================================================
  // Control
  // ===========================================================================
  ...
  applyDisplayStateUpdate(event) {
    ...
    switch (event.type) {
      ...
      case "tool_update": {
        ...
        if (tool) {
          tool.partialResult = typeof event.partialResult === "string" ? event.partialResult : chunkAX6D722J_cjs.safeStringify(event.partialResult);
        }
        break;
      }
      case "tool_end": {
  ...
  async buildRequestContext(requestContext) {
    requestContext ??= new chunkKF4FCWWL_cjs.RequestContext();
