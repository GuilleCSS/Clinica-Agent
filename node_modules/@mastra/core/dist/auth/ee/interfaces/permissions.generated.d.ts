 ...
 */
export declare const RESOURCES: readonly ["a2a", "agent-builder", "agents", "background-tasks", "channels", "datasets", "embedders", "experiments", "logs", "mcp", "memory", "observability", "processor-providers", "processors", "schedules", "scores", "stored", "stored-agents", "system", "tool-providers", "tools", "vector", "vectors", "workflows", "workspaces"];
/**
 * Resource type union.
 */
 ...
 */
export declare const ACTIONS: readonly ["create", "delete", "execute", "read", "write"];
/**
 * Action type union.
 */
 ...
 */
export declare const PERMISSIONS: readonly ["a2a:read", "a2a:write", "agent-builder:execute", "agent-builder:read", "agent-builder:write", "agents:create", "agents:delete", "agents:execute", "agents:read", "agents:write", "background-tasks:read", "channels:read", "channels:write", "datasets:delete", "datasets:execute", "datasets:read", "datasets:write", "embedders:read", "experiments:read", "logs:read", "mcp:execute", "mcp:read", "mcp:write", "memory:delete", "memory:execute", "memory:read", "memory:write", "observability:read", "observability:write", "processor-providers:read", "processors:execute", "processors:read", "schedules:execute", "schedules:read", "schedules:write", "scores:read", "scores:write", "stored-agents:delete", "stored-agents:read", "stored-agents:write", "stored:delete", "stored:read", "stored:write", "system:read", "tool-providers:read", "tools:execute", "tools:read", "vector:delete", "vector:execute", "vector:read", "vector:write", "vectors:read", "workflows:delete", "workflows:execute", "workflows:read", "workflows:write", "workspaces:delete", "workspaces:read", "workspaces:write"];
/**
...
export declare const MastraFGAPermissions: {
    ...
    /** Delete stored */
    readonly STORED_DELETE: "stored:delete";
    /** View stored */
    readonly STORED_READ: "stored:read";
    /** Create and modify stored */
    readonly STORED_WRITE: "stored:write";
    /** View system info */
