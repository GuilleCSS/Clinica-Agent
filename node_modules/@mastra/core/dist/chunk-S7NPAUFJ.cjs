...
var NetlifyGateway = class extends chunk6CFOTCM4_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunk6CFOTCM4_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
        return chunk6CFOTCM4_cjs.createGoogleGenerativeAI({
...
//# sourceMappingURL=chunk-S7NPAUFJ.cjs.map
//# sourceMappingURL=chunk-S7NPAUFJ.cjs.map