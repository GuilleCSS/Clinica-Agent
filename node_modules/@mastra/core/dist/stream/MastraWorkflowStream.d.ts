...
export declare class MastraWorkflowStream<TState, TInput, TOutput, TSteps extends Step<string, any, any>[]> extends ReadableStream<ChunkType> {
    #private;
    ...
    get status(): Promise<"success" | "failed" | "tripwire" | "suspended" | "paused">;
    get result(): Promise<import("../workflows").WorkflowResult<TState, TInput, TOutput, TSteps> | undefined>;
    get usage(): Promise<{
        inputTokens: number;
        outputTokens: number;
        totalTokens: number;
