import type { LanguageModelV2FinishReason, LanguageModelV2Usage, LanguageModelV2CallWarning, LanguageModelV2Prompt, LanguageModelV2ResponseMetadata, LanguageModelV2StreamPart } from '@ai-sdk/provider-v5';
import type { FinishReason, LanguageModelRequestMetadata, LogProbs as LanguageModelV1LogProbs } from '../_types/@internal_ai-sdk-v4/dist/index.js';
import type { CallSettings, ModelMessage, StepResult, ToolSet, TypedToolCall, UIMessage } from '../_types/@internal_ai-sdk-v5/dist/index.js';
