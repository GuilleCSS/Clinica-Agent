...
var scoringEntityTypeSchema = v4.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunkEGOKFX44_cjs.SpanType)]);
...
var scoreRowDataSchema = v4.z.object({
  ...
  // Timestamps
  ...chunkEGOKFX44_cjs.dbTimestamps
});
...
var listScoresResponseSchema = v4.z.object({
  pagination: chunkEGOKFX44_cjs.paginationInfoSchema,
...
var spanTypeField = v4.z.nativeEnum(chunkEGOKFX44_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var sharedFields = {
  ...chunkEGOKFX44_cjs.spanContextFields,
  metadata: chunkEGOKFX44_cjs.metadataField.nullish(),
  tags: chunkEGOKFX44_cjs.tagsField.nullish()
};
var spanIds = {
  traceId: chunkEGOKFX44_cjs.traceIdField,
  spanId: chunkEGOKFX44_cjs.spanIdField
};
var spanIdsSchema = v4.z.object({
  ...spanIds
});
var omitDbTimestamps = createOmitKeys(chunkEGOKFX44_cjs.dbTimestamps);
...
var getSpanArgsSchema = v4.z.object({
  traceId: chunkEGOKFX44_cjs.traceIdField.min(1),
  spanId: chunkEGOKFX44_cjs.spanIdField.min(1)
...
var getSpansArgsSchema = v4.z.object({
  traceId: chunkEGOKFX44_cjs.traceIdField.min(1),
  spanIds: v4.z.array(chunkEGOKFX44_cjs.spanIdField.min(1)).min(1).describe("Span IDs to fetch within the trace")
...
var lightSpanRecordSchema = v4.z.object({
  ...
  entityType: chunkEGOKFX44_cjs.spanContextFields.entityType,
  entityId: chunkEGOKFX44_cjs.spanContextFields.entityId,
  entityName: chunkEGOKFX44_cjs.spanContextFields.entityName,
  // Database timestamps
  ...chunkEGOKFX44_cjs.dbTimestamps
}).describe(
...
var tracesFilterSchema = v4.z.object({
  // Date range filters
  startedAt: chunkEGOKFX44_cjs.dateRangeSchema.optional().describe("Filter by span start time range"),
  endedAt: chunkEGOKFX44_cjs.dateRangeSchema.optional().describe("Filter by span end time range"),
  // Span type filter
  spanType: spanTypeField.optional(),
  // Identifier filter (matches the root span's trace identifier)
  traceId: chunkEGOKFX44_cjs.traceIdField.optional().describe("Filter by trace ID (matches root span)"),
  // Shared fields
  ...sharedFields,
...
var tracesOrderBySchema = v4.z.object({
  ...
  direction: chunkEGOKFX44_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listTracesArgsSchema = v4.z.object({
  filters: tracesFilterSchema.optional().describe("Optional filters to apply"),
  pagination: chunkEGOKFX44_cjs.paginationArgsSchema.default({ page: 0, perPage: 10 }).describe("Pagination settings"),
...
var branchesFilterSchema = v4.z.object({
  ...
  spanType: spanTypeField.optional(),
  // Identifier filters
  traceId: chunkEGOKFX44_cjs.traceIdField.optional().describe("Filter by parent trace ID"),
...
var listBranchesArgsSchema = v4.z.object({
  ...
  pagination: chunkEGOKFX44_cjs.paginationArgsSchema.default({ page: 0, perPage: 10 }).describe("Pagination settings"),
  orderBy: branchesOrderBySchema.default({ field: "startedAt", direction: "DESC" }).describe("Ordering configuration (defaults to startedAt desc)")
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(chunkEGOKFX44_cjs.traceIdField)
...
var scoreTracesRequestSchema = v4.z.object({
  ...
  targets: v4.z.array(
    v4.z.object({
      traceId: chunkEGOKFX44_cjs.traceIdField,
      spanId: chunkEGOKFX44_cjs.spanIdField.optional()
    })
  ).min(1)
});
...
function unwrapSchema(schema) {
  ...
  let nullable = false;
  while (true) {
    const typeName = chunkRLPRSIR2_cjs.getZodTypeName(current);
    if (!typeName) break;
    if (typeName === "ZodNullable" || typeName === "ZodOptional") {
      nullable = true;
    }
    const inner = chunkRLPRSIR2_cjs.getZodInnerType(current, typeName);
    if (!inner) break;
    current = inner;
  }
...
function zodToStorageType(schema) {
  const typeName = chunkRLPRSIR2_cjs.getZodTypeName(schema);
...
//# sourceMappingURL=chunk-XXKOQCB4.cjs.map
//# sourceMappingURL=chunk-XXKOQCB4.cjs.map