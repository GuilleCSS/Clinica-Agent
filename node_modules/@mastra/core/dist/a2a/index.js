...
var ErrorCodeContentTypeNotSupported = -32005;
var ErrorCodeInvalidAgentResponse = -32006;
var ErrorCodeExtendedAgentCardNotConfigured = -32007;
var ErrorCodeExtensionSupportRequired = -32008;
var ErrorCodeVersionNotSupported = -32009;
...
var MastraA2AError = class _MastraA2AError extends Error {
  ...
  static contentTypeNotSupported(contentType) {
    return new _MastraA2AError(ErrorCodeContentTypeNotSupported, `Content type not supported: ${contentType}`, {
      contentType
    });
  }
  static invalidAgentResponse(message, data) {
    return new _MastraA2AError(ErrorCodeInvalidAgentResponse, message, data);
  }
  static extendedAgentCardNotConfigured() {
    return new _MastraA2AError(ErrorCodeExtendedAgentCardNotConfigured, "Extended agent card is not configured");
  }
  static extensionSupportRequired(extension) {
    return new _MastraA2AError(
  ...
  static versionNotSupported(version) {
    return new _MastraA2AError(ErrorCodeVersionNotSupported, `Version not supported: ${version}`, { version });
  }
};
