...
import type { MastraLanguageModelV3 } from '../../shared.types.js';
 ...
 */
export declare class AISDKV6LanguageModel implements MastraLanguageModelV3 {
    #private;
    /**
    ...
    doGenerate(options: LanguageModelV3CallOptions): Promise<{
        ...
        content: Array<import("@ai-sdk/provider-v6").LanguageModelV3Content>;
        finishReason: import("@ai-sdk/provider-v6").LanguageModelV3FinishReason;
        usage: import("@ai-sdk/provider-v6").LanguageModelV3Usage;
        providerMetadata?: import("@ai-sdk/provider-v6").SharedV3ProviderMetadata;
