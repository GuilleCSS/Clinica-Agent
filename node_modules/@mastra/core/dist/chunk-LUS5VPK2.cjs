...
var chunkSAI37VFF_cjs = require('./chunk-SAI37VFF.cjs');
var chunkS32LFLPN_cjs = require('./chunk-S32LFLPN.cjs');
var chunkS7NPAUFJ_cjs = require('./chunk-S7NPAUFJ.cjs');
var chunk6CFOTCM4_cjs = require('./chunk-6CFOTCM4.cjs');
var chunkY73X6U5P_cjs = require('./chunk-Y73X6U5P.cjs');
var chunkGLBBBSS5_cjs = require('./chunk-GLBBBSS5.cjs');
var chunk4U7ZLI36_cjs = require('./chunk-4U7ZLI36.cjs');
var chunkKF4FCWWL_cjs = require('./chunk-KF4FCWWL.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkY73X6U5P_cjs.createStreamFromGenerateResult(result)
    };
  }
...
var openaiFailedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler({
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: {
                      url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunk6CFOTCM4_cjs.convertToBase64(part.data)}`,
                  ...
                  if (part.data instanceof URL) {
                    throw new chunk6CFOTCM4_cjs.UnsupportedFunctionalityError({
                  ...
                  switch (part.mediaType) {
                    case "audio/wav": {
                      return {
                        type: "input_audio",
                        input_audio: {
                          data: chunk6CFOTCM4_cjs.convertToBase64(part.data),
                          format: "wav"
                        }
                      };
                    }
                  ...
                  return {
                    ...
                    file: typeof part.data === "string" && part.data.startsWith("file-") ? { file_id: part.data } : {
                      ...
                      file_data: `data:application/pdf;base64,${chunk6CFOTCM4_cjs.convertToBase64(part.data)}`
                    }
                  };
                } else {
                  throw new chunk6CFOTCM4_cjs.UnsupportedFunctionalityError({
...
var openaiChatResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var openaiChatChunkSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b, _c, _d;
    const warnings = [];
    const openaiOptions = (_a = await chunk6CFOTCM4_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    } = await chunk6CFOTCM4_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunk6CFOTCM4_cjs.combineHeaders(this.config.headers(), options.headers),
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createJsonResponseHandler(
    ...
    for (const toolCall of (_a = choice.message.tool_calls) != null ? _a : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b = toolCall.id) != null ? _b : chunk6CFOTCM4_cjs.generateId(),
    ...
    for (const annotation of (_c = choice.message.annotations) != null ? _c : []) {
      content.push({
        type: "source",
        sourceType: "url",
        id: chunk6CFOTCM4_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type != null && toolCallDelta.type !== "function") {
                    throw new chunk6CFOTCM4_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_o = toolCall2.function) == null ? void 0 : _o.name) != null && ((_p = toolCall2.function) == null ? void 0 : _p.arguments) != null) {
                    ...
                    if (chunk6CFOTCM4_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_q = toolCall2.id) != null ? _q : chunk6CFOTCM4_cjs.generateId(),
                ...
                if (((_v = toolCall.function) == null ? void 0 : _v.name) != null && ((_w = toolCall.function) == null ? void 0 : _w.arguments) != null && chunk6CFOTCM4_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_x = toolCall.id) != null ? _x : chunk6CFOTCM4_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunk6CFOTCM4_cjs.InvalidPromptError({
...
var openaiCompletionResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAICompletionLanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openaiOptions = {
      ...await chunk6CFOTCM4_cjs.parseProviderOptions({
        provider: "openai",
        providerOptions,
...
var openaiEmbeddingProviderOptions = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
...
var openaiTextEmbeddingResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var OpenAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunk6CFOTCM4_cjs.TooManyEmbeddingValuesForCallError({
        provider: this.provider,
        modelId: this.modelId,
    ...
    const {
      ...
      headers: chunk6CFOTCM4_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
var openaiImageResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunk6CFOTCM4_cjs.postJsonToApi({
      url: this.config.url({
...
var openaiTranscriptionResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
...
var openAITranscriptionProviderOptions = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openAIOptions = await chunk6CFOTCM4_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openAITranscriptionProviderOptions
    });
    const formData = new FormData();
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunk6CFOTCM4_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunk6CFOTCM4_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunk6CFOTCM4_cjs.postFormDataToApi({
      url: this.config.url({
...
var openaiSpeechProviderOptionsSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
var localShellInputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
...
var localShellOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${chunk6CFOTCM4_cjs.convertToBase64(part.data)}`
                    },
          ...
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                const parsedInput = await chunk6CFOTCM4_cjs.validateTypes({
                  value: part.input,
            ...
            case "reasoning": {
              const providerOptions = await chunk6CFOTCM4_cjs.parseProviderOptions({
                provider: "openai",
      ...
      case "tool": {
        for (const part of content) {
          ...
          if (hasLocalShellTool && part.toolName === "local_shell" && output.type === "json") {
            const parsedOutput = await chunk6CFOTCM4_cjs.validateTypes({
              value: output.value,
...
var openaiResponsesChunkSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
...
var openaiResponsesResponseSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var openaiResponsesProviderOptionsSchema = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterInputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
        v4.z.discriminatedUnion("type", [
...
var codeInterpreterArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterToolFactory = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var fileSearchArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var fileSearchOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      queries: v4.z.array(v4.z.string()),
      results: v4.z.array(
...
var fileSearch = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var webSearchArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var webSearchInputSchema = chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreviewArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search_preview",
  name: "web_search_preview",
  inputSchema: webSearchPreviewInputSchema,
  outputSchema: webSearchPreviewOutputSchema
});
var imageGenerationArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var imageGenerationInputSchema = chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
      ...
      case "provider-defined": {
        switch (tool.id) {
          case "openai.file_search": {
            const args = await chunk6CFOTCM4_cjs.validateTypes({
              value: tool.args,
...
var OpenAIResponsesLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunk6CFOTCM4_cjs.APICallError({
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                content.push({
                  type: "source",
                  sourceType: "url",
                  id: (_f = (_e = (_d = this.config).generateId) == null ? void 0 : _e.call(_d)) != null ? _f : chunk6CFOTCM4_cjs.generateId(),
                  url: annotation.url,
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_i = (_h = (_g = this.config).generateId) == null ? void 0 : _h.call(_g)) != null ? _i : chunk6CFOTCM4_cjs.generateId(),
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : chunk6CFOTCM4_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = this.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunk6CFOTCM4_cjs.generateId(),
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_r = (_q = (_p = self.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : chunk6CFOTCM4_cjs.generateId(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = self.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunk6CFOTCM4_cjs.generateId(),
                  mediaType: "text/plain",
...
// ../../node_modules/.pnpm/@ai-sdk+azure@2.0.105_zod@4.3.6/node_modules/@ai-sdk/azure/dist/index.mjs
...
function createAzure(options = {}) {
  ...
  const getHeaders = () => {
    const baseHeaders = {
      "api-key": chunk6CFOTCM4_cjs.loadApiKey({
    ...
    return chunk6CFOTCM4_cjs.withUserAgentSuffix(baseHeaders, `ai-sdk/azure/${VERSION}`);
  };
  const getResourceName = () => chunk6CFOTCM4_cjs.loadSetting({
...
var AzureOpenAIGateway = class extends chunk6CFOTCM4_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  id = "azure-openai";
  name = "azure-openai";
  tokenCache = new chunkGLBBBSS5_cjs.InMemoryServerCache();
  ...
  async resolveLanguageModel({
    ...
    const azureConfig = {
      ...
      headers: { "User-Agent": chunk6CFOTCM4_cjs.MASTRA_USER_AGENT, ...headers }
    };
    if (useEntraId) {
      return createAzure({
        ...azureConfig,
...
function createOpenAIWebSocketFetch(options) {
  ...
  function getConnection(authorization, headers) {
    ...
    connecting = new Promise((resolve2, reject) => {
...
function getStaticProvidersByGateway(name) {
  return Object.fromEntries(Object.entries(chunkSAI37VFF_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name));
}
var defaultGateways = [
  new chunkS7NPAUFJ_cjs.NetlifyGateway(),
  new chunkSAI37VFF_cjs.MastraGateway(),
  new chunkS32LFLPN_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))
];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const allGateways = customGateways?.length ? [...customGateways, ...defaultGateways.filter((dg) => !customGateways.some((cg) => cg.id === dg.id))] : defaultGateways;
    ...
    const parsed = chunkS32LFLPN_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkS32LFLPN_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkY73X6U5P_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunk6CFOTCM4_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const modelInstance = chunk6CFOTCM4_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
async function resolveModelConfig(modelConfig, requestContext = new chunkKF4FCWWL_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof chunkY73X6U5P_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkY73X6U5P_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var VERSION2 = "2.0.70" ;
var googleErrorDataSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      error: v4.z.object({
...
var googleFailedResponseHandler = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler({
...
var googleGenerativeAIEmbeddingProviderOptions = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunk6CFOTCM4_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
    ...
    const mergedHeaders = chunk6CFOTCM4_cjs.combineHeaders(
      await chunk6CFOTCM4_cjs.resolve(this.config.headers),
      headers
    );
...
var googleGenerativeAITextEmbeddingResponseSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAIProviderOptions = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a = config.generateId) != null ? _a : chunk6CFOTCM4_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createJsonResponseHandler(responseSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunk6CFOTCM4_cjs.combineHeaders(
      await chunk6CFOTCM4_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    let finishReason = "unknown";
...
var responseSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var chunkSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
...
var codeExecution = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var enterpriseWebSearch = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
  id: "google.enterprise_web_search",
  name: "enterprise_web_search",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})))
});
...
var fileSearchArgsSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(fileSearchArgsBaseSchema)
);
var fileSearch2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
  id: "google.file_search",
  name: "file_search",
  inputSchema: fileSearchArgsSchema2
});
var googleMaps = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
...
var googleSearchToolArgsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(googleSearchToolArgsBaseSchema)
);
var googleSearch = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
  id: "google.google_search",
  name: "google_search",
  inputSchema: googleSearchToolArgsSchema
});
var urlContext = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
  id: "google.url_context",
  name: "url_context",
  inputSchema: chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})))
});
var vertexRagStore = chunk6CFOTCM4_cjs.createProviderDefinedToolFactory({
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunk6CFOTCM4_cjs.postJsonToApi({
      ...
      headers: chunk6CFOTCM4_cjs.combineHeaders(await chunk6CFOTCM4_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunk6CFOTCM4_cjs.createJsonResponseHandler(
...
var googleImageResponseSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
var googleImageProviderOptionsSchema = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunk6CFOTCM4_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => chunk6CFOTCM4_cjs.withUserAgentSuffix(
    {
      "x-goog-api-key": chunk6CFOTCM4_cjs.loadApiKey({
        apiKey: options.apiKey,
  ...
  const createChatModel = (modelId) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunk6CFOTCM4_cjs.generateId,
      supportedUrls: () => ({
        "*": [
...
var openaiErrorDataSchema2 = v4.z.object({
  error: v4.z.object({
    message: v4.z.string(),
    // The additional information below is handled loosely to support
    // OpenAI-compatible providers that have slightly different error
...
var openaiFailedResponseHandler2 = chunk6CFOTCM4_cjs.createJsonErrorResponseHandler({
...
var openaiChatResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiChatChunkSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
       * Modify the likelihood of specified tokens appearing in the completion.
...
var openaiCompletionResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
      Echo back the prompt in addition to the completion.
...
var openaiEmbeddingProviderOptions2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
      The number of dimensions the resulting output embeddings should have.
...
var openaiTextEmbeddingResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      data: v4.z.array(v4.z.object({ embedding: v4.z.array(v4.z.number()) })),
      usage: v4.z.object({ prompt_tokens: v4.z.number() }).nullish()
...
var openaiImageResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
function distributeTokenDetails2(usage, index, total) {
  if (usage == null) {
    return {};
  }
  const result = {};
...
var codeInterpreterInputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      code: v4.z.string().nullish(),
      containerId: v4.z.string()
...
var codeInterpreterOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
        v4.z.discriminatedUnion("type", [
...
var codeInterpreterArgsSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      container: v4.z.union([
        v4.z.string(),
...
var codeInterpreterToolFactory2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.code_interpreter",
  name: "code_interpreter",
...
var comparisonFilterSchema2 = v4.z.object({
  key: v4.z.string(),
  type: v4.z.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: v4.z.union([v4.z.string(), v4.z.number(), v4.z.boolean(), v4.z.array(v4.z.string())])
});
var compoundFilterSchema2 = v4.z.object({
  type: v4.z.enum(["and", "or"]),
  filters: v4.z.array(
    v4.z.union([comparisonFilterSchema2, v4.z.lazy(() => compoundFilterSchema2)])
  )
});
var fileSearchArgsSchema3 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      vectorStoreIds: v4.z.array(v4.z.string()),
      maxNumResults: v4.z.number().optional(),
      ...
      filters: v4.z.union([comparisonFilterSchema2, compoundFilterSchema2]).optional()
    })
  )
);
var fileSearchOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      queries: v4.z.array(v4.z.string()),
      results: v4.z.array(
...
var fileSearch3 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema2
});
var imageGenerationArgsSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      background: v4.z.enum(["auto", "opaque", "transparent"]).optional(),
      inputFidelity: v4.z.enum(["low", "high"]).optional(),
...
var imageGenerationInputSchema2 = chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.image_generation",
  name: "image_generation",
...
var localShellInputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
        type: v4.z.literal("exec"),
...
var localShellOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
var localShell2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.local_shell",
  name: "local_shell",
  inputSchema: localShellInputSchema2,
  outputSchema: localShellOutputSchema2
});
var webSearchArgsSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      externalWebAccess: v4.z.boolean().optional(),
      filters: v4.z.object({ allowedDomains: v4.z.array(v4.z.string()).optional() }).optional(),
...
var webSearchInputSchema2 = chunk6CFOTCM4_cjs.lazySchema(() => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchToolFactory2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search",
  name: "web_search",
...
var webSearchPreviewArgsSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema2 = chunk6CFOTCM4_cjs.lazySchema(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview2 = chunk6CFOTCM4_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search_preview",
  name: "web_search_preview",
...
async function convertToOpenAIResponsesInput2({
  prompt,
  systemMessageMode,
  fileIdPrefixes,
  store,
...
var openaiResponsesReasoningProviderOptionsSchema2 = v4.z.object({
  itemId: v4.z.string().nullish(),
  reasoningEncryptedContent: v4.z.string().nullish()
});
...
var openaiResponsesChunkSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        type: v4.z.literal("response.output_text.delta"),
...
var openaiResponsesResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().optional(),
      created_at: v4.z.number().optional(),
...
var openaiResponsesProviderOptionsSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      conversation: v4.z.string().nullish(),
      include: v4.z.array(
       ...
       * @see https://cookbook.openai.com/examples/using_logprobs
       */
      logprobs: v4.z.union([v4.z.boolean(), v4.z.number().min(1).max(TOP_LOGPROBS_MAX2)]).optional(),
      /**
       * The maximum number of total calls to built-in tools that can be processed in a response.
       * This maximum number applies across all built-in tool calls, not per individual tool.
       * Any further attempts to call a tool by the model will be ignored.
...
var openaiSpeechProviderOptionsSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      instructions: v4.z.string().nullish(),
      speed: v4.z.number().min(0.25).max(4).default(1).nullish()
...
var openaiTranscriptionResponseSchema2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
      language: v4.z.string().nullish(),
...
var openAITranscriptionProviderOptions2 = chunk6CFOTCM4_cjs.lazyValidator(
  () => chunk6CFOTCM4_cjs.zodSchema(
    v4.z.object({
      /**
       * Additional information to include in the transcription response.
...
function createOpenAI2(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunk6CFOTCM4_cjs.withoutTrailingSlash(
    chunk6CFOTCM4_cjs.loadOptionalSetting({
  ...
  const getHeaders = () => chunk6CFOTCM4_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunk6CFOTCM4_cjs.loadApiKey({
        apiKey: options.apiKey,
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunk6CFOTCM4_cjs.createOpenAICompatible({
      ...
      const registry = chunkSAI37VFF_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-LUS5VPK2.cjs.map
//# sourceMappingURL=chunk-LUS5VPK2.cjs.map