...
var WorkspacesStorage = class extends chunkA3NDWEDZ_cjs.VersionedStorageDomain {
  listKey = "workspaces";
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      configs = configs.filter((config) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkAX6D722J_cjs.deepEqual(config.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-DDVJ7BU5.cjs.map
//# sourceMappingURL=chunk-DDVJ7BU5.cjs.map