...
var PromptBlocksStorage = class extends chunkA3NDWEDZ_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      blocks = blocks.filter((block) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkAX6D722J_cjs.deepEqual(block.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-5JXIKYBM.cjs.map
//# sourceMappingURL=chunk-5JXIKYBM.cjs.map