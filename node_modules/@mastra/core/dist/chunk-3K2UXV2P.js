...
// ../../node_modules/.pnpm/@ai-sdk+provider-utils@3.0.23_zod@4.3.6/node_modules/@ai-sdk/provider-utils/dist/index.mjs
var dist_exports = {};
        ...
        new TransformStream({
          ...
          flush(controller) {
            ...
            controller.enqueue({
              ...
              finishReason,
              usage: {
                inputTokens: (_b18 = usage.promptTokens) != null ? _b18 : void 0,
...
var MASTRA_USER_AGENT = `mastra/${"1.32.1"}` ;
...
async function convertToAnthropicMessagesPrompt({
  ...
  var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
  const betas = /* @__PURE__ */ new Set();
      ...
      case "assistant": {
        ...
        for (let j = 0; j < block.messages.length; j++) {
          ...
          for (let k = 0; k < content.length; k++) {
            ...
            const cacheControl = (_f = validator2.getCacheControl(part.providerOptions, {
              type: "assistant message part",
              canCache: true
            })) != null ? _f : isLastContentPart ? validator2.getCacheControl(message.providerOptions, {
