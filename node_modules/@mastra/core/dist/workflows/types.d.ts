...
import type { TextStreamPart } from '../_types/@internal_ai-sdk-v4/dist/index.js';
...
export type StepResult<P, R, S, T> = StepSuccess<P, R, S, T> | StepFailure<P, R, S, T> | StepSuspended<P, S, T> | StepRunning<P, R, S, T> | StepWaiting<P, R, S, T> | StepPaused<P, R, S, T>;
/**
 ...
 */
export type SerializedStepResult<P, R, S, T> = StepSuccess<P, R, S, T> | SerializedStepFailure<P, R, S, T> | StepFailure<P, R, S, T> | StepSuspended<P, S, T> | StepRunning<P, R, S, T> | StepWaiting<P, R, S, T> | StepPaused<P, R, S, T>;
...
export type WorkflowRunStatus = 'running' | 'success' | 'failed' | 'tripwire' | 'suspended' | 'waiting' | 'pending' | 'canceled' | 'bailed' | 'paused';
/**
...
type InferParsedPublicSchema<TSchema extends PublicSchema<any>> = TSchema extends {
    _output: infer Output;
} ? Output : InferPublicSchema<TSchema>;
/**
