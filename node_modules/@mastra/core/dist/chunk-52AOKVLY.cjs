...
var ScorerDefinitionsStorage = class extends chunkA3NDWEDZ_cjs.VersionedStorageDomain {
...
var InMemoryScorerDefinitionsStorage = class extends ScorerDefinitionsStorage {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      scorers = scorers.filter((scorer) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkAX6D722J_cjs.deepEqual(scorer.metadata[key], value));
      });
    }
  ...
  async listVersions(input) {
    ...
    const perPage = chunkA3NDWEDZ_cjs.normalizePerPage(perPageInput, 20);
    if (page < 0) {
      throw new Error("page must be >= 0");
    }
    const maxOffset = Number.MAX_SAFE_INTEGER / 2;
...
var FilesystemScorerDefinitionsStorage = class extends ScorerDefinitionsStorage {
  ...
  constructor({ db }) {
    super();
    this.helpers = new chunkA3NDWEDZ_cjs.FilesystemVersionedHelpers({
      db,
...
//# sourceMappingURL=chunk-52AOKVLY.cjs.map
//# sourceMappingURL=chunk-52AOKVLY.cjs.map